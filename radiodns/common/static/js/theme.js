...
var Sidebar = {
	initialize: function () {
		...
		// Removed temporarilydue to mobile issue #218
...
function updateContentPadding() {
    // Update content padding according to menubar height
    $("#content").css("padding-top", (35 + $(".menubar").height()));
    $("#content").css("min-height", ($("#sidebar-flat").height()));
}
