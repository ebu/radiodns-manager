    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scaled112x32', models.ImageField(blank=True, null=True, upload_to='')),
                ('scaled128x128', models.ImageField(blank=True, null=True, upload_to='')),
                ('scaled320x240', models.ImageField(blank=True, null=True, upload_to='')),
                ('scaled600x600', models.ImageField(blank=True, null=True, upload_to='')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='manager.Organization'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
