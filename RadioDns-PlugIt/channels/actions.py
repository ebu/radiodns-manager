...
def channels_home(request):
    ...
    return {'list': list, 'expected_fqdn': expected_fqdn, 'saved': saved, 'deleted': deleted}
...
def channels_export(request):
    ...
    retour += '; GENERATED BY EBU RADIODNS MANAGER v2\n'
    retour += '; http://ebu.io/radiodns\n\n'
    ...
    if request.args.get('to') == 'file':
        ...
        retour_str.seek(0)
        return PlugItSendFile(retour_str, 'text/plain', True, zoneName+'zone')
